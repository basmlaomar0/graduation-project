 ...
 ///////////////////////////////////////////////
           Padding(
             ...
             offset: Offset(4, 4),
               ...
               child: SizedBox(
                 width: 140, // العرض اللي انتي عايزاه
                 height: 140, // الطول اللي انتي عايزاه
                 child: Image.asset(
                   'images/Glove.png',
                   fit: BoxFit.cover,
                 ),
           ...
           Padding(
                       ...
                       textAlign: TextAlign.left,
                       style: TextStyle(
                         color: const Color.fromARGB(255, 9, 14, 24),
                         fontSize: 17,
                         fontWeight: FontWeight.bold,
                       ),
                       ),
                       ...
                       color:Colors.green, // لون الأيقونة حسب الشحن
                               ),
                               SizedBox(height: 5,),
                        Text(
                       'Right Hand',
                       ...
                       textAlign: TextAlign.left,
                       style: TextStyle(
                         color: const Color.fromARGB(255, 22, 151, 69),
                         fontSize: 15,
                         fontWeight: FontWeight.bold,
                       ),
                       ),
